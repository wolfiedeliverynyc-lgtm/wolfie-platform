...
export const RESTAURANTS: Restaurant[] = [
  {
    ...
    layout: 'cyberpunk',
    instagram: 'neotokyo_ramen',
    facebook: 'neotokyonyc',
  ...
  },
  {
    ...
    layout: 'elegant',
    instagram: 'trufflegrove_nyc',
    facebook: 'trufflegrove',
  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        description: 'Fresh-squeezed lemonade infused with premium coconut activated charcoal, raw wildflower honey, and fresh mint.',
        price: 6.50,
        category: 'Elixirs',
  ...
  },
  {
    ...
    layout: 'bento',
    instagram: 'dolcevelvet_gelato',
    facebook: 'dolcevelvet',
    phone: '+1 (212) 555-0094',
    menu: [
      {
        id: 'd_m1',
      ...
      {
        id: 'd_m2',
        name: 'Madagascar Gelato Pint (16oz)',
  ...
  },
  {
    ...
    chefImage: 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&w=300&h=300&q=80',
    layout: 'bento',
    instagram: 'vesuvius_smashed',
    facebook: 'vesuviusfire',
