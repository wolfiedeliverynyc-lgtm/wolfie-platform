...
import { Restaurant, Address, OrderStatus } from '../../../lib/types';
...
export default function InteractiveMap({ restaurant, address, status }: InteractiveMapProps) {
  ...
  if (!mounted) {
    return (
      <div className="w-full h-full bg-slate-50 rounded-2xl animate-pulse flex items-center justify-center text-slate-450 border border-slate-200">
        Loading interactive GPS mapping...
      </div>
    );
  }
    ...
    <div className="relative w-full h-full bg-slate-50 rounded-2xl overflow-hidden shadow-sm border border-slate-200/60 flex flex-col justify-between" id="tracking-map-container">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="text-sm font-medium text-slate-800 flex items-center space-x-1">
              <span>Marcus is </span>
              <span className="text-emerald-700 font-semibold px-1 rounded bg-emerald-5
      ...
      <div className="absolute bottom-4 right-4 z-10 flex flex-col space-y-2">
        <button
          ...
          className="p-2.5 bg-white hover:bg-slate-55 text-slate-600 hover:text-slate-950 rounded-lg border border-slate-200 shadow-sm transition-all active:scale-95 cursor-pointer"
          title="Zoom In"
        >
      ...
      >
        ...
        >
          ...
          >
            ...
            <g stroke="#e2e8f0" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round">
            ...
            {status !== 'placed' && (
              <g transform={`translate(${riderPos.x}, ${riderPos.y})`}>
                <circle r="28" fill="#3b82f6" fillOpacity="0.1" />
