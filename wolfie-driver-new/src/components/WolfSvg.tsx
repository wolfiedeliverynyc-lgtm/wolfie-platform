...
export default function WolfSvg({ className = 'w-32 h-32' }: WolfSvgProps) {
  return (
    ...
    >
      ...
      <path d="M70 54 L46 22 L54 60 Z" fill="var(--primary)" />

      {/* Right Ear */}
      <path d="M125 52 L164 8 L146 62 Z" fill="#cbd5e1" stroke="#0f172a" strokeWidth="4" strokeLinejoin="round" />
      <path d="M130 54 L154 22 L146 60 Z" fill="var(--primary)" />
      ...
      <path d="M90 44 L110 44 L100 74 Z" fill="var(--primary)" />
      ...
      {/* Wolf Glow Eyes */}
      {/* Left Eye */}
      <path d="M60 81 L86 86 L71 89 Z" fill="var(--primary)" stroke="#0f172a" strokeWidth="2" strokeLinejoin="round" />
      <circle cx="73" cy="85" r="1.5" fill="#ffffff" />
      <path d="M58 79 L88 85" stroke="var(--primary)" strokeWidth="3" strokeLinecap="round" />

      {/* Right Eye */}
      <path d="M140 81 L114 86 L129 89 Z" fill="var(--primary)" stroke="#0f172a" strokeWidth="2" strokeLinejoin="round" />
      <circle cx="127" cy="85" r="1.5" fill="#ffffff" />
      <path d="M142 79 L112 85" stroke="var(--primary)" strokeWidth="3" strokeLinecap="round" />
      ...
      <path d="M68 152 L100 184 L132 152 L115 159 L100 154 L85 159 Z" fill="var(--primary)" stroke="#0f172a" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
