    ...
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        ...
        <div id="main" className="relative group">
          <input placeholder="Search..." type="text" name="text" className="bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white text-lg focus:outline-none placeholder-gray-400" style={{ paddingLeft: '59px', paddingRight: '59px' }} />
